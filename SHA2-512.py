...
message += message_length.to_bytes(16, byteorder="big")
...
digest = "".join(map(lambda x: x.to_bytes(8, byteorder="big").hex(), (h0, h1, h2, h3, h4, h5, h6, h7)))
print(digest)

assert digest == "07e547d9586f6a73f73fbac0435ed76951218fb7d0c8d788a309d785436bbb642e93a252a954f23912547d1e8a3b5ed6e1bfd7097821233fa0538f3db854fee6"
